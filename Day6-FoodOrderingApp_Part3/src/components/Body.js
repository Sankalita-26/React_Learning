...
const Body=()=>{
  ...
  const fetchData=async()=>{
    const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=22.5790417&lng=88.3716054&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
